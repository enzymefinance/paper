...
All Melon tokens collected in form of usage fees will go into a smart contract(s) called a \textit{Governance and Multichain fund}. The purpose of this fund is that Melon token Holders can vote to spend tokens to cover the costs of deploying Melon on other future blockchains or to cover the costs of governance of the Melon protocol.
