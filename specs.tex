...
A Melon fund is created by triggering the Solidity function version.setupFund(P) on the latest protocol version contract. Where the input parameters P are:
...
\subsubsection{Setup of a new Melon fund}
...
\subsubsection{Participant invests in a Melon fund}
...
\subsubsection{Participant redeems from a Melon fund}
...
\subsubsection{Manager makes an order}
...
\subsubsection{Manager takes an orders}
...
\subsubsection{Manager converts rewards into shares}
...
\subsubsection{Manager shuts down the fund}
