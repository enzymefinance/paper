...
A participant starts to invest in a fund \textit{F} by first creating a subscription request \textit{R}. Parameters to be specified are:
...
R is then executed in the way described in \ref{invest}.
