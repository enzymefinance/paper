...
Redemptions from a Melon fund can be requested as either (i) a redemption directly in MLN, or (ii) redeeming a \textit{slice} of the fund's allocation, proportional to the amount of shares being redeemed.
...
Similar to above, a manager may also disable redemption \textit{in MLN}.

The option to redeem in slices, as described in \ref{redeem}
